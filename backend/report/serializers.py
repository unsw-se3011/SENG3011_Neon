...
class ReporteventSerializer(serializers.ModelSerializer):
    ...
    latitude = serializers.DecimalField(
        source="Location.latitude", max_digits=24, decimal_places=20)
    # longitude of Reportevent
    longitude = serializers.DecimalField(
        source="Location.longitude", max_digits=24, decimal_places=20)
    # start_date
    ...
    class Meta:
        ...
        fields = ('report_type', 'start_date', 'end_date',
                  'number_effecet', 'location_name', 'latitude', 'longitude')
